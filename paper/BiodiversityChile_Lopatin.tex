...
unique, and neither map says whether the site conserves deep lineages. Recovering
compositional turnover from spectral data has long been posed as a problem in its own right
rather than a by-product of richness mapping \citep{rocchini2018measuring}, and the
benchmarks that exist delineate spectral communities rather than quantify how much an
individual site contributes to the turnover of its region \citep{rocchini2021from}.
...
signal collapsed in every family (Table~\ref{tab:llto}). PD$_0$ fell below zero everywhere,
and TD$_0$ fell from 0.66--0.78 under spatial blocking to seed means between $-0.63$ and
$-0.82$ for the three networks. Those network means are not point estimates in any useful
sense: their seed standard deviations reach 0.57 to 0.93, so individual seeds disagree about
whether the model is catastrophically wrong or merely wrong, and we report them only to show
the direction and the instability. Random Forest is the exception on both counts. It stayed
near zero on TD$_0$ ($-0.097$) with seeds agreeing to within 0.007, and it was the only
family whose seven facets all lie above $-0.10$. LCBD was the one facet that retained
positive skill under this scheme, from 0.344 for the two-dimensional network to 0.419 for
Random Forest, a loss of 0.03 to 0.09 relative to spatial blocking; the differences among
families here (0.344 to 0.380 for the networks) are of the order of their own seed
dispersion (0.041 to 0.054) and we do not rank them.
...
deviation over seeds; bold marks the highest mean per facet. The networks' TD$_0$ standard
deviations exceed half a unit of $R^2$, so those means describe an unstable failure rather
than a level.}
\label{tab:llto}
\begin{tabular}{lcccc}
\toprule
...
\midrule
LCBD   & $\mathbf{0.419\pm0.003}$ & $0.376\pm0.041$ & $0.344\pm0.054$ & $0.380\pm0.047$ \\
PD$_0$ & $\mathbf{-0.061\pm0.014}$ & $-0.168\pm0.153$ & $-0.154\pm0.114$ & $-0.166\pm0.088$ \\
PD$_1$ & $\mathbf{0.032\pm0.005}$ & $-0.170\pm0.115$ & $-0.146\pm0.106$ & $-0.167\pm0.086$ \\
PD$_2$ & $\mathbf{0.017\pm0.009}$ & $-0.305\pm0.142$ & $-0.219\pm0.111$ & $-0.233\pm0.091$ \\
TD$_0$ & $\mathbf{-0.097\pm0.007}$ & $-0.820\pm0.928$ & $-0.789\pm0.861$ & $-0.627\pm0.570$ \\
TD$_1$ & $\mathbf{-0.088\pm0.014}$ & $-0.101\pm0.156$ & $-0.156\pm0.117$ & $-0.136\pm0.101$ \\
TD$_2$ & $\mathbf{-0.001\pm0.012}$ & $-0.078\pm0.021$ & $-0.097\pm0.040$ & $-0.087\pm0.029$ \\
\bottomrule
\end{tabular}
\end{table}
...
survived the joint spatial and temporal hold-out (0.34 to 0.42). The abundance- and
