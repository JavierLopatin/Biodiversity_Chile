...
gave a higher mean $R^2$ over the three informative facets than the composite annual curve
(Table~\ref{tab:curveformat}). The raw series scored above the composite on LCBD, PD$_0$
and TD$_0$ by 0.005, 0.027 and 0.083; seed standard deviations were 0.005 to 0.006 for
LCBD, 0.016 to 0.032 for PD$_0$ and 0.020 to 0.060 for TD$_0$, so the differences on LCBD
and PD$_0$ lie within dispersion and the difference on TD$_0$ exceeds it. The composite
curve scored marginally higher on the abundance-weighted facets, but all those values lie
within 0.06 of zero. We fixed the raw series for all subsequent analyses.

\begin{table}[t]
\centering
\footnotesize
\caption{Out-of-fold $R^2$ by curve format (raw three-year series or composite annual
curve); two-dimensional network, kNDVI, spatial block cross-validation, mean over five
seeds. Bold marks the higher value per facet.}
\label{tab:curveformat}
\begin{tabular}{lrrr}
\toprule
Facet & $n$ & Raw series & Composite curve \\
\midrule
LCBD   & 2,499 & \textbf{0.417} & 0.412 \\
PD$_0$ & 888   & \textbf{0.598} & 0.571 \\
PD$_1$ & 888   & $-0.004$ & \textbf{0.006} \\
PD$_2$ & 888   & 0.053 & \textbf{0.059} \\
TD$_0$ & 895   & \textbf{0.769} & 0.686 \\
TD$_1$ & 895   & $-0.126$ & \textbf{0.005} \\
TD$_2$ & 895   & $-0.060$ & \textbf{$-0.030$} \\
\bottomrule
\end{tabular}
\end{table}
...
PD$_0$ reached 0.58 to 0.61 and TD$_0$ 0.67 to 0.79. The three neural networks scored within
0.02 of one another on both facets, less than one seed standard deviation (0.017 to 0.032),
whereas Random Forest scored 0.03 lower on PD$_0$ and 0.11 lower on TD$_0$, the latter
several times the dispersion. LCBD was moderately predictable (0.42 to 0.45); Random Forest
scored highest on it (0.447), 0.010 to 0.027 above the networks, with seed standard
deviations of 0.003 to 0.007. The abundance-weighted facets stayed at or near zero in every
family. The only positive values were isolated and not replicated across families: PD$_1$
(0.049) and PD$_2$ (0.091) for the one-dimensional network and TD$_1$ (0.042) for Random
Forest, each with a seed standard deviation of a similar order or with negative
counterparts in the other families.
...
measurable gain under this design. The masked-autoencoder initialisation produced the
highest observed values on PD$_0$ (0.613) and TD$_0$ (0.786), 0.005 and 0.014 above the
network trained from scratch and within one seed standard deviation of it, and it
transferred nothing to LCBD or to the abundance-weighted facets. Given the input-side
overlap between its pretraining pool and the test folds (Section~\ref{sec:models}), we
treat these values as exploratory.
...
\midrule
LCBD   & $0.434 \pm 0.005$ & $\mathbf{0.447 \pm 0.003}$ & $0.420 \pm 0.007$ & $0.437 \pm 0.005$ \\
PD$_0$ & $0.608 \pm 0.032$ & $0.582 \pm 0.002$ & $0.612 \pm 0.028$ & $\mathbf{0.613 \pm 0.017}$ \\
PD$_1$ & $0.011 \pm 0.031$ & $0.004 \pm 0.011$ & $\mathbf{0.049 \pm 0.018}$ & $-0.010 \pm 0.047$ \\
PD$_2$ & $0.065 \pm 0.014$ & $0.054 \pm 0.001$ & $\mathbf{0.091 \pm 0.013}$ & $0.040 \pm 0.029$ \\
TD$_0$ & $0.772 \pm 0.020$ & $0.666 \pm 0.018$ & $0.780 \pm 0.028$ & $\mathbf{0.786 \pm 0.024}$ \\
TD$_1$ & $-0.178 \pm 0.074$ & $\mathbf{0.042 \pm 0.025}$ & $-0.144 \pm 0.146$ & $-0.181 \pm 0.071$ \\
TD$_2$ & $-0.079 \pm 0.061$ & $-0.073 \pm 0.014$ & $-0.064 \pm 0.035$ & $-0.090 \pm 0.054$ \\
\bottomrule
\end{tabular}
\end{table}
